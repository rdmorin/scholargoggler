      ...
      sidebarPanel(
        ...
        conditionalPanel(
          ...
          selectInput("fancycolour","Use fancy colour scheme",
                    ...
                    selected="Hokusai1"),
          textInput("coolor","Use custom palette",
                    placeholder="https://coolors.co/df9a57-fc7a57-fcd757-eefc57-5e5b52"),
          h5("Enter a complete URL from coolors.co"),
          checkboxInput("dillute","Transparency based on frequency?",value=FALSE)
        ),
